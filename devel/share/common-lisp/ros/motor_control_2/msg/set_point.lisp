...
(cl:defmethod cl:initialize-instance :after ((m <set_point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor_control_2-msg:<set_point> is deprecated: use motor_control_2-msg:set_point instead.")))
